...
class WCS_ATT_Order {
	...
	public static function init() {
		...
		add_filter( 'woocommerce_get_product_from_item', array( __CLASS__, 'restore_product_from_order_item' ), 10, 3 );
	...
	*/
	 ...
	 * @return WC_Product
	 */
	public static function restore_product_from_order_item( $product, $order_item, $order ) {
		if ( null !== ( $scheme_key = self::get_subscription_scheme( $order_item ) ) ) {
